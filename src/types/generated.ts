...
export type DefaultHeaderBlockRecordListListNonNullMultiLocaleField = {
  __typename?: 'DefaultHeaderBlockRecordListListNonNullMultiLocaleField';
  locale?: Maybe<SiteLocale>;
  value: Array<DefaultHeaderBlockRecord>;
};
...
export type HeroBlockRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  emphasizedText?: Maybe<Scalars['String']['output']>;
  id: Scalars['ItemId']['output'];
...
export type HomePageRecord = RecordInterface & {
  ...
  _allHeaderLocales?: Maybe<Array<DefaultHeaderBlockRecordListListNonNullMultiLocaleField>>;
  ...
  header: Array<DefaultHeaderBlockRecord>;
  id: Scalars['ItemId']['output'];
