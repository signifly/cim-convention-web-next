...
export type HeaderModelBlocksField = AnnouncementBannerBlockRecord | DefaultHeaderBlockRecord;
...
export type HomePageModelBodyField = AdBannerBlockRecord | AdThreeColumnBlockRecord | CardsContainerBlockRecord | CtaBlockRecord | DividerBlockRecord | HeroBlockRecord | PageHeaderBlockRecord | StatisticsBlockRecord | TestimonialsBlockRecord | TwoColumnWithImageBlockRecord | VideoBlockRecord;
...
export type HomePageRecord = RecordInterface & {
  ...
  _allBodyLocales?: Maybe<Array<HomePageModelBodyFieldListListNonNullMultiLocaleField>>;
...
export type PageModelBodyField = AdBannerBlockRecord | AdThreeColumnBlockRecord | CardsContainerBlockRecord | CtaBlockRecord | DividerBlockRecord | HeroBlockRecord | PageHeaderBlockRecord | StatisticsBlockRecord | TestimonialsBlockRecord | TwoColumnWithImageBlockRecord | VideoBlockRecord;
...
export type PageRecord = RecordInterface & {
  ...
  _allBodyLocales?: Maybe<Array<PageModelBodyFieldListListNonNullMultiLocaleField>>;
  _allSeoSettingsLocales?: Maybe<Array<SeoFieldMultiLocaleField>>;
...
/** Block of type Past Conventions Block > Past Convention (past_convention) */
export type PastConventionRecord = RecordInterface & {
  __typename?: 'PastConventionRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
...
/** Block of type Past Conventions Block > Past Convention (past_convention) */
export type PastConventionRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type PastConventionsBlockRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  conventions: Array<PastConventionRecord>;
  id: Scalars['ItemId']['output'];
  title?: Maybe<Scalars['String']['output']>;
};
...
export type TwoColumnWithImageBlockModelTextContentField = TwoColumnWithImageBlockDefaultRecord | TwoColumnWithImageBlockWithFeatureListRecord | TwoColumnWithImageBlockWithHeadingHighlightRecord;
...
export type TwoColumnWithImageBlockWithHeadingHighlightRecord = RecordInterface & {
...
export type AllPagesQueryQuery = { __typename?: 'Query', allPages: Array<{ __typename?: 'PageRecord', id: string, title: string, _status: ItemStatus, _firstPublishedAt?: string | null, slug: string }> };
